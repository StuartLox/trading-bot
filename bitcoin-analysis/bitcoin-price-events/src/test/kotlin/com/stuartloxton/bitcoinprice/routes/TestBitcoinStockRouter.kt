...
//        response = StockResponse("", any(), "Hello")
    ...
    fun teststockEventProducer() {
        val mockSenderResult = object : SenderResult<Any> {
            override fun exception() = null
            override fun correlationMetadata() = TODO("not implemented")
            override fun recordMetadata() = TODO("not implemented")
        }
        val stock1 = getStock()
